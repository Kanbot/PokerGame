...
public class Pokertable {
	...
	public static void main(String[] args) {
		...
		double[] Bat = {100,0,0}; // ¹èÆÃ ±İ¾×, ¹èÆÃ ÅäÅ«, ¼±ÈÄ Â÷·Ê
		
		double player; //ÇÃ·¹ÀÌ¾î ¼± ÅäÅ«
		double dealer; //µô·¯ ¼± ÅäÅ«		
		double player_money =100000; // ÇÃ·¹ÀÌ¾î ¼ÒÁö±İ 		
		...
		while(player_money !=0) { // °ÔÀÓ ¹İº¹ °æ°è
			Bat[0] =100; // º¯¼ö ÃÊ±âÈ­
			Bat[1] =0;
			Bat[2] =0;
			//Ä«µå µ¦ ÃÊ±âÈ­
		...
		///µÎ¹øÂ° ¿ÀÇÂ Ä«µå ÆäÀÌÁî //////////////////////////////////////////////////
			...
			Bat=bt.ifd(Bat[0],Bat[1],Bat[2]); // µô·¯ ¹èÆÃ
		...
		///// ¹èÆÃ ÆäÀÌÁî ///////////////////////////////////////////////////////////
			...
			System.out.println("´ÙÀ½ ÆÇÀ» ÇÏ½Ã°Ú½À´Ï±î?");
